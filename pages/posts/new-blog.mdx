...
My tech stack has simplified alot, but there were still some fun toys for me to play with while setting up this blog. The basis of the blog comes from the Next.js [blog starter](https://github.com/zeit/next.js/tree/canary/examples/blog-starter). This was a great start and allowed me to focus on getting up and running without spending too much time on the basics. I did spend some time adding some improvements to the starter that I go over below. I'm hosting the site on [Vercel](https://vercel.com/) which has been great for ease of deployment. The starter is using [TailwindCSS](https://tailwindcss.com/) for all of the styling. This is my first real chance to use TailwindCSS and it has been great so far. I really like the utility based rules, they really seem to help keep things consistent for me.

### Improvements

One of the first changes I did was switch from regular markdown to [MDX](https://mdxjs.com/).
